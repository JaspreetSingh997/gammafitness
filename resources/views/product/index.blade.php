    ...
    <section id="productLandingHome">
        ...
        <div class="" id="header">
            <div class="productMainName">
                <h1>Gamma Fitness Premium Rubber Coated Bouncer Dumbbells</h1>
            </div>
        </div>
        <section id="mainContent">
            <h1>Lorem ipsum et one</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores neque exercitationem amet vitae quo,
                enim
                dolorum laboriosam. Quod tempora ut distinctio magnam illum eveniet optio officiis temporibus. Aliquam,
                odit
                minima.</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex magnam velit quisquam ipsa amet, quibusdam at
                sed
                sit fugit. Earum, excepturi! Id necessitatibus atque quaerat laborum facere accusantium aliquid
                officiis!
            </p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga, numquam illo. Odit quae nobis voluptatum
                suscipit sequi illo molestias consequuntur! Sapiente pariatur culpa labore rerum soluta obcaecati qui,
        ...
        <div class="videoPane">
            <video id="dumbVid" width="100%" height="100%" autoplay loop>
                <source src="{{asset('videos/dumbellMain.mp4')}}" type="video/mp4"></source>
            </video>
        </div>
